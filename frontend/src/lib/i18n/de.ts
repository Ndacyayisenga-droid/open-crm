...
export const de = {
  ...
  companies: {
    ...
    deleteDialog: {
      title: "Firma löschen",
      descriptionAll: "Firma '{name}' und ALLE zugehörigen Kontakte löschen? Alle Kommentare und Tag-Zuordnungen werden unwiderruflich gelöscht.",
      descriptionOnly: "Nur die Firma '{name}' löschen? Kontakte bleiben erhalten, aber die Firmenzuordnung wird entfernt. Kommentare und Tags der Firma werden gelöscht.",
  ...
  contacts: {
    ...
    deleteDialog: {
      ...
      description:
        "Möchten Sie '{name}' wirklich löschen? Alle Kommentare werden unwiderruflich gelöscht.",
  ...
  backup: {
    ...
    trigger: {
      ...
      errorGeneric: "Backup-Service nicht verfügbar.",
    },
    list: {
  ...
  csvImport: {
    ...
    upload: {
      description: "CSV-Datei wählen (max. 20 MB, 5.000 Zeilen). Spalten werden im nächsten Schritt zugeordnet.",
    ...
    mapping: {
      description: "Ordnen Sie jede CSV-Spalte einem Kontaktfeld zu. Vorname und Nachname sind Pflichtfelder.",
      column: "Quellspalte",
      target: "Zielfeld",
      ignore: "Ignorieren",
      requiredHint: "Vorname und Nachname müssen jeweils genau einmal zugeordnet werden.",
      duplicateHint: "Jedes Zielfeld darf nur einmal zugeordnet werden.",
      targets: {
        TITLE: "Titel",
        FIRST_NAME: "Vorname",
        LAST_NAME: "Nachname",
    ...
    preview: {
      description: "Prüfen Sie die ersten drei zugeordneten Zeilen. Ungültige Felder sind hervorgehoben.",
      row: "Zeile",
      noErrors: "Gültig",
    },
    result: {
      summary: "{created} erstellt, {failed} fehlgeschlagen",
      downloadFailures: "Fehler-CSV herunterladen",
      columns: {
        row: "Zeile",
        field: "Feld",
        reason: "Grund",
  ...
  errors: {
    forbidden: {
      ...
      deleteNoPermission: "Löschen nicht erlaubt — APP-ADMIN-Rolle erforderlich.",
    },
    roleRequired: {
      admin: "APP-ADMIN-Rolle erforderlich",
