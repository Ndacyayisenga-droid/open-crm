...
export const en: Translations = {
  ...
  companies: {
    ...
    form: {
      ...
      bankName: "Bank",
      bankNamePlaceholder: "e.g. Deutsche Bank",
      bic: "BIC",
      bicPlaceholder: "e.g. DEUTDEDB",
      iban: "IBAN",
      ibanPlaceholder: "e.g. DE89370400440532013000",
      vatId: "VAT ID",
    ...
    deleteDialog: {
      ...
      descriptionAll: "Delete the company '{name}' and ALL associated contacts? All comments and tag associations will be permanently deleted.",
      descriptionOnly: "Delete only the company '{name}'? Contacts will be kept but their company association will be removed. Company comments and tags will be deleted.",
  ...
  contacts: {
    ...
    form: {
      ...
      networkWebsite: "Website",
      placeholderGithub: "username",
      placeholderLinkedin: "username or /in/slug",
      placeholderX: "username",
      placeholderMastodon: "@user@instance",
      placeholderBluesky: "handle.bsky.social",
      placeholderDiscord: "numeric user ID",
      ...
      errorGeneric: "An error occurred. Please try again.",
      imageTooLarge: "File is too large (max. 2 MB)",
      imageInvalidFormat: "Please choose a JPEG, PNG, WebP, or HEIC file.",
      managedByBrevo: "Managed by Brevo",
    },
    deleteDialog: {
      title: "Delete Contact",
      description:
        "Do you really want to delete '{name}'? All comments will be permanently deleted.",
  ...
  backup: {
    ...
    status: {
      ...
      notConfigured: "Backup service is not configured.",
      unavailable: "Backup service is not available.",
      healthy: "Connected.",
      infoUnavailable: "Service info could not be loaded.",
      version: "Version",
      pgDumpVersion: "pg_dump version",
      retention: "Retention",
      interval: "Interval",
      lastBackupAge: "Last backup",
    },
    trigger: {
      title: "Manual backup",
      button: "Trigger backup",
      triggered: "Backup triggered — Job ID {jobId}",
      alreadyRunning: "Backup already running — Job ID {jobId}",
      errorGeneric: "Backup service is not available.",
    },
    list: {
      ...
      download: "Download",
      sha256Copy: "Copy hash",
      sha256Copied: "Hash copied.",
      errorGeneric: "Backup service is not available.",
    },
  },
  brevo: {
  ...
  csvImport: {
    ...
    upload: {
      description: "Choose a CSV file (max 20 MB, 5,000 rows). Columns can be mapped in the next step.",
    ...
    mapping: {
      description: "Assign each CSV column to a contact field. First name and last name are required.",
      column: "Source column",
      target: "Maps to",
      ignore: "Ignore",
      requiredHint: "Map first name and last name exactly once each.",
      duplicateHint: "Each target can only be mapped once.",
      targets: {
        TITLE: "Title",
    ...
    preview: {
      description: "Review the first three mapped rows. Invalid fields are highlighted.",
      row: "Row",
      noErrors: "Valid",
    },
    result: {
      summary: "{created} created, {failed} failed",
      downloadFailures: "Download failure CSV",
      columns: {
        row: "Row",
        field: "Field",
        reason: "Reason",
    ...
    errors: {
      ...
      forbidden: "You do not have permission to import contacts.",
  ...
  errors: {
    forbidden: {
      ...
      deleteNoPermission: "Delete not allowed — APP-ADMIN role required.",
    },
    roleRequired: {
      admin: "APP-ADMIN role required",
